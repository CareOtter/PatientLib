...
@implementation EmergencyPatientDto

- (instancetype)initWithBondObject:(void*)obj {
  if (self = [super init]) {
    ::EmergencyPatient* castObj = (::EmergencyPatient*)obj;
...
- (instancetype)initWithByteArray: (uint8_t*)byteArray length:(uint32_t)len {
  ::EmergencyPatient obj = CppBondSerializer<::EmergencyPatient>::deserializeFromByteArray(byteArray, len);
  return [self initWithBondObject: &obj];
}

- (void*)toBondObject {
  ::EmergencyPatient* obj = new EmergencyPatient();
...
-(const uint8_t*) toByteArray: (uint32_t*)resultLen {
  auto obj = (::EmergencyPatient*)[self toBondObject];
  return CppBondSerializer<::EmergencyPatient>::serializeToByteArray(*obj, resultLen);
}
