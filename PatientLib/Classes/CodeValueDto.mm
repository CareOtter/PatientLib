...
#import <InteractionSchema_reflection.h>
#import <CodeValueDto.h>

@implementation CodeValueDto

- (instancetype)initWithBondObject:(void*)obj {
  if (self = [super init]) {
    ::CodeValue* castObj = (::CodeValue*)obj;
...
- (instancetype)initWithByteArray: (uint8_t*)byteArray length:(uint32_t)len {
  ::CodeValue obj = CppBondSerializer<::CodeValue>::deserializeFromByteArray(byteArray, len);
...
-(const uint8_t*) toByteArray: (uint32_t*)resultLen {
  auto obj = (::CodeValue*)[self toBondObject];
  return CppBondSerializer<::CodeValue>::serializeToByteArray(*obj, resultLen);
}
