...
@implementation RelatedOrderDto

- (instancetype)initWithBondObject:(void*)obj {
  if (self = [super init]) {
    ::RelatedOrder* castObj = (::RelatedOrder*)obj;
...
- (instancetype)initWithByteArray: (uint8_t*)byteArray length:(uint32_t)len {
  ::RelatedOrder obj = CppBondSerializer<::RelatedOrder>::deserializeFromByteArray(byteArray, len);
  return [self initWithBondObject: &obj];
}

- (void*)toBondObject {
  ::RelatedOrder* obj = new RelatedOrder();
...
-(const uint8_t*) toByteArray: (uint32_t*)resultLen {
  auto obj = (::RelatedOrder*)[self toBondObject];
  return CppBondSerializer<::RelatedOrder>::serializeToByteArray(*obj, resultLen);
}
