...
#ifndef LocatableBaseEntityDto_h
#define LocatableBaseEntityDto_h
@interface LocatableBaseEntityDto: BaseEntityDto<DtoType>

@property CoordinatesDto* coordinates;
