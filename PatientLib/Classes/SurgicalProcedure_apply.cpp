...
//   File : SurgicalProcedure_apply.cpp
//
...
namespace Schemas
{
    ...
    //
    // Overloads of Apply function with common transforms for SurgicalProcedure.
    // These overloads will be selected using argument dependent lookup
    // before bond::Apply function templates.
    //
    bool Apply(const bond::To<SurgicalProcedure>& transform,
               const bond::bonded<SurgicalProcedure>& value)
    {
        return bond::Apply<>(transform, value);
    }

    bool Apply(const bond::InitSchemaDef& transform,
               const SurgicalProcedure& value)
    {
        return bond::Apply<>(transform, value);
    }
    
    bool Apply(const bond::To<SurgicalProcedure>& transform,
               const bond::bonded<SurgicalProcedure, bond::CompactBinaryReader<bond::InputBuffer>&>& value)
    {
        return bond::Apply<>(transform, value);
    }
    ...
    bool Apply(const bond::Serializer<bond::CompactBinaryWriter<bond::OutputBuffer> >& transform,
               const bond::bonded<SurgicalProcedure, bond::FastBinaryReader<bond::InputBuffer>&>& value)
    {
        return bond::Apply<>(transform, value);
    }
    
    bool Apply(const bond::Serializer<bond::CompactBinaryWriter<bond::OutputBuffer> >& transform,
               const bond::bonded<SurgicalProcedure, bond::SimpleBinaryReader<bond::InputBuffer>&>& value)
    {
        return bond::Apply<>(transform, value);
    }
