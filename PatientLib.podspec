...
Pod::Spec.new do |s|
  s.name             = "PatientLib"
  s.version          = "0.1.0"
  s.summary          = "A short description of PatientLib."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/PatientLib"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Scott Mueller" => "scott.mueller@careotter.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/PatientLib.git", :tag => s.version.to_s }
